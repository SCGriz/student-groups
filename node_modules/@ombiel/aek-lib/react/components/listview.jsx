...
var ListviewItem = React.createClass({
  ...
  render:function() {
    ...
    if(thumbnail || icon) {
      ...
      if(thumbSize) { thumbClass += " " + thumbSize; }
      if(thumbnail) {
        thumb = thumbSize && <aek-img style={{backgroundImage:`url(${thumbnail})`}} /> || <img src={thumbnail}/>;
...
var Listview = React.createClass({
  ...
  itemFactory:function(item,index) {
    ...
    ["label","thumbnail","icon","text","heading","active","href","disabled"].forEach(function(prop) {
